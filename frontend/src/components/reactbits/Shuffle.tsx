  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        splitRef.current = new (GSAPSplitText as any)(el, {
          type: 'chars',
      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            if (isVertical) {
              gsap.set(strips, { y: (_i, t: any) => parseFloat(t.getAttribute('data-start-y') || '0') });
            } else {
              gsap.set(strips, { x: (_i, t: any) => parseFloat(t.getAttribute('data-start-x') || '0') });
            }
            onShuffleComplete?.();
          },
          onComplete: () => {
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          ...
          if (isVertical) {
            vars.y = (_i: number, t: any) => parseFloat(t.getAttribute('data-final-y') || '0');
          } else {
            vars.x = (_i: number, t: any) => parseFloat(t.getAttribute('data-final-x') || '0');
          }
